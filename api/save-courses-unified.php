<?php
// API per salvare i corsi nel file unificato corsi.json
...
function logDebug($message) {
    error_log("[SAVE-COURSES-UNIFIED] " . $message);
}
...
try {
    ...
    if (!isset($data['courses'])) {
        throw new Exception('Missing required data: courses');
    }

    $courses = $data['courses'];
    logDebug("Courses count: " . count($courses));

    // Percorso del file unificato
    $jsonFile = __DIR__ . '/../lib/corsi.json';
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Courses saved successfully to unified file',
